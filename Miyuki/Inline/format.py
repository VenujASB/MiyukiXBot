...
Miyuki supports a large number of formatting 
...
- <code>[hyperlink](google.com)</code>: This will create a <a href='https://t.me/TeamMiyukiBot'>hyperlink</a> text.
...
Alternatively, check out <a href='https://t.me/VenujaST'>This Web site</a> to generate the button syntax for yoctx.
...
tetx="""
Another thing that can be fun, is to randomize the contents of a message.
