...
from Miyuki.mongo.notesdb import Notes, NotesSettings
from Miyuki.utils.cmd_senders import send_cmd
from Miyuki.utils.custom_filters import admin_filter, command, owner_filter
from Miyuki.utils.kbhelpers import rkb as ikb
from Miyuki.utils.msg_types import Types, get_note_type
            ...
            reply_markup=ikb(
                [
                    [
                        (
                            "Click Me!",
                            f"https://t.me/TheMiyukiXBot?start=note_{m.chat.id}_{note_hash}",
                            "url",
                        ),
                    ],
                ],
        ...
        pm_kb = ikb(
            [
                [
                    (
                        "All Notes",
                        f"https://t.me/TheMiyukiXBot?start=notes_{grp_id}",
                        "url",
                    ),
                ],
            ],
