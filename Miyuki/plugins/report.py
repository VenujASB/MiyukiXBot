...
from Miyuki.mongo.reportdb import Reporting
...
Miyuki will then reply with a message stating that admins have been notified. 
...
or when used to report an admin. Miyuki assumes that admins 
