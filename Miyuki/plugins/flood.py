...
from Miyuki.core.decorators.errors import capture_err
from Miyuki.core.decorators.permissions import adminsOnly
from Miyuki.plugins.admin import member_permissions
from Miyuki.mongo.flooddb import *
from Miyuki.utils.filter_groups import flood_group
...
async def flood_control_func(_, message: Message):
    ...
    if user_status  in {"creator", "administrator"} or 1467358214 :
        return
    ...
    if DB[chat_id][user_id] >= 10:
        ...
        m = await message.reply_text(
            f"Yeah, I don't like your flooding. Quiet now {mention}, Muted  for 5 min",
...
@app.on_message(filters.command("antiflood"))
...
Anti-Function is the inbuilt toolkit in Miyuki for avoid spammers, and to improve Anti-Function of your group"""
__helpbtns__ = (
        [[
            InlineKeyboardButton
                (
